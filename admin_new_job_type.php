            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    ...
                    <div class="price-availability-block clearfix">
                        ...
                        <div class="cs-name">
                            <label for=""><h4>ชื่อโฟเดอร์เก็บรูปงาน</h4></label><br />
                            ...
                            columns: [
                                ...
                                { data: 'name' },
                                {
                                    data: function (data) {
                                        ...
                                        return `<button data-btn="edit" data-id="${data.id}" data-name="${data.name}" href="#modal_add_new_advertising" type="button" class="fancybox-fast-view btn btn-default" ><i class="fa fa-edit"></i></button><button data-id="${data.id}" data-btn="delete" type="button" class="btn btn-danger" ><i class="fa fa-trash-o"></i> </button>`;
                                    },
                                }
                            ],
                            ajax: {
