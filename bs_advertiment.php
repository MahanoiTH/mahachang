...
<body class="ecommerce">
  ...
  <div class="main">
    <div class="container">
      ...
      <div class="row margin-bottom-40">
        <!-- BEGIN SALE PRODUCT -->
        <b class="h2 margin-bottom-40">เลือกประเภทงานที่ต้องการ ฝากประกาศ</b>
        <hr>
  ...
  <script type="text/javascript">
    ...
    var attc_list = [];
    var attc_list_name = [];
    var data_url = 'bs_datatable_advertiment.php';
      ...
      var Maha = function () {
        ...
        return {
          ...
          submitFile: function (id) {
            ...
            $.ajax({
              url: "bs_db_ajax_move_files_advertising.php",
              method: "POST",
              data: data, // ส่งค่า product_id ไปยัง cart.php
              processData: false,  // อย่าจัดการข้อมูลเอง
              contentType: false,  // ประเภทข้อมูลอ้างอิงไปที่ไฟล์แนบ
