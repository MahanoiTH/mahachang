...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $sql = "SELECT jobs_electrical.id,jobs_electrical.job_order, jobs_electrical.phone_number, jobs_electrical.client_name, jobs_electrical.job_description,jobs_electrical.email,
